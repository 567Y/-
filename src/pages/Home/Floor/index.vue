                      ...
                      <div class="floorBanner">
                          <div class="swiper-container" ref="floor1Swiper">
                              <div class="swiper-wrapper">
                                  <div class="swiper-slide" v-for="(swiper, index) in floor.carouselList" :key="swiper.id">
...
export default {
  ...
  props: ['floor'],
  mounted(){
        //现在swiper实例是可以直接写在mounted中的 因为Floor组件的数据是父组件给的 请求是父组件发的
