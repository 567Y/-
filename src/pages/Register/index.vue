  ...
  methods: {
   ...
   async userRegister(){
      try {
        ...
        //派发一个action 获取注册用户接口信息
        //填写了手机号和验证码并且两次密码相同才可以注册并派发一个action
        // phone && code && password == rePassword && await this.$store.dispatch('userRegister',{phone,password,code});
